...
descriptif_application <- function() {
  tags$div(
    ...
    tags$b("Info :"),
    tags$ul(
      tags$li("L\'application donne des informations et d\u00e9crit le trafic du m\u00e9tro parisien pour l\'ann\u00e9e 2017 par stations, ligne et type de jour s\u00e9lectionn\u00e9"),
      tags$li("Le nombre de validations calcul\u00e9 ne comptabilise que les entr\u00e9s sur le r\u00e9seau avec une carte d\'abonnement."),
      tags$li("Les validations avec un ticket ainsi que les validations de sortie ne sont donc pas prises en compte.")
    ),
    tags$b("Donn\u00e9es :"),
    tags$ul(
      tags$li(
        "L\'application a \u00e9t\u00e9 cr\u00e9\u00e9 \u00e0 partir des donn\u00e9es Open du STIF : ", 
    ...
    tags$div("Pour en voir plus, n\'h\u00e9sitez pas \u00e0 visiter notre site ", 
